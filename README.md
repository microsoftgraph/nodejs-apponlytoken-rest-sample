...
6. Run `npm start` to run the app.
  ...
  > Note: This app will iterate through all users in your tenant and create a calendar event on each of their calendars. The event will have the title "Microsoft Graph API discussion", will be 30 minutes long, and will be exactly 24 hours from when you run from the app.
